    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20">
          ...
          <div className="text-3xl font-display font-bold text-indigo-600 dark:text-indigo-400 mb-2">
            {debounceCount}
          </div>
          <div className="text-sm text-indigo-700 dark:text-indigo-300 truncate">
            "{debouncedText}"
          </div>
          <div className="mt-2 text-[10px] text-indigo-400/80">
        ...
        <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20">
          ...
          <div className="text-3xl font-display font-bold text-emerald-600 dark:text-emerald-400 mb-2">
            {throttleCount}
          </div>
