...
export const KnowledgeLab = () => {
  ...
  return (
    <section
      id="knowledge-lab"
      className="py-32 relative overflow-hidden bg-slate-50 dark:bg-black/20"
    >
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-lg">
            A living sandbox of core web development concepts. Because building UIs is great, but
            understanding what happens under the hood is what makes a senior engineer.
          </p>
        </div>
          ...
          <div className="lg:w-1/4 flex flex-col gap-2">
            {concepts.map((concept) => {
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div layoutId="activeTabBg" className="absolute inset-0 bg-white/10" />
                  )}
                  <Icon
                    size={20}
                    className={cn('shrink-0', isActive ? 'text-white' : 'text-accent')}
                  />
