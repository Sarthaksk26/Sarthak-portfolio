...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-black text-slate-100 antialiased selection:bg-accent/30 selection:text-accent">
      <a
        href="#main"
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
            ...
            <div className="flex gap-6">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-accent transition-all"
                >
                  <social.icon size={20} />
                </a>
              ))}
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-slate-600">
              © {new Date().getFullYear()} Sarthak. Built with React 19 & Tailwind 4.
            </p>
