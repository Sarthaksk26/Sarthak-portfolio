  ...
  return (
    <div className="space-y-20">
      <section className="pt-8">
        <div className="max-w-3xl">
          ...
          <div className="flex gap-3">
            <a href="/resume.pdf" className="px-4 py-2 bg-accent text-white rounded">Download Resume</a>
            <a href="mailto:you@example.com" className="px-4 py-2 border rounded">Contact</a>
          </div>
        </div>
      </section>
      ...
      <section id="contact">
        ...
        <p className="text-slate-700">Email me at <a href="mailto:you@example.com" className="text-accent">you@example.com</a></p>
      </section>
    </div>
  );
}